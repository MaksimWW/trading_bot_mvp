...
class RiskManager:
    ...
    def calculate_position_size(self, 
        ...
        try:
            ...
            max_position_by_risk = (self.settings.max_position_size_percent / 
                                  max(price_risk_percent, 1.0)) * 100
    ...
    def assess_portfolio_risk(self, positions: list) -> Dict:
        ...
        try:
            ...
            result = {
                ...
                "risk_utilization": round((total_risk / self.settings.max_portfolio_risk_percent) * 100, 1),
    ...
    def _generate_portfolio_recommendations(self, 
        ...
        for sector, exposure in sector_exposure.items():
            if exposure > self.settings.sector_concentration_limit:
                recommendations.append(f"📊 Высокая концентрация в секторе {sector}: {exposure:.1f}%")
